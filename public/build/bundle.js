    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "href", "");
    			add_location(a, file$7, 5, 31, 90);
    			attr_dev(span, "class", "bold");
    			add_location(span, file$7, 7, 4, 162);
    			attr_dev(p0, "class", "body-text");
    			add_location(p0, file$7, 4, 2, 36);
    			attr_dev(p1, "class", "body-text");
    			add_location(p1, file$7, 13, 2, 586);
    			add_location(section, file$7, 3, 0, 23);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$6, 16, 0, 357);
    			html_tag.a = t3;
    			html_tag_1.a = t4;
    			html_tag_2.a = t5;
    			attr_dev(p, "class", "body-text");
    			add_location(p, file$6, 17, 0, 408);
    			attr_dev(button, "class", "svelte-wigwt4");
    			add_location(button, file$6, 31, 2, 944);
    			attr_dev(div, "class", "button-div svelte-wigwt4");
    			add_location(div, file$6, 30, 0, 916);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "body-header");
    			add_location(h1, file$5, 39, 0, 1053);
    			attr_dev(p, "class", "body-text");
    			add_location(p, file$5, 40, 0, 1116);
    			...
    			add_location(line0, file$5, 73, 4, 2115);
    			...
    			add_location(path3, file$5, 97, 4, 2827);
    			...
    			add_location(text0, file$5, 101, 4, 2944);
    			...
    			add_location(text1, file$5, 107, 4, 3127);
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 65, 8, 2153);
    		},
    		m: function mount(target, anchor) {
    			for (let i = 0; i < each_blocks.length; i += 1) {
    				if (each_blocks[i]) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$3, 50, 0, 1604);
    			attr_dev(p0, "class", "body-text");
    			add_location(p0, file$3, 51, 0, 1657);
    			attr_dev(div0, "class", "steps-container svelte-1tar3ok");
    			add_location(div0, file$3, 58, 4, 1902);
    			attr_dev(svg0, "id", "chart3");
    			attr_dev(svg0, "class", "svelte-1tar3ok");
    			add_location(svg0, file$3, 70, 8, 2282);
    			attr_dev(div1, "class", "chart-one svelte-1tar3ok");
    			add_location(div1, file$3, 69, 6, 2249);
    			attr_dev(svg1, "id", "chart4");
    			attr_dev(svg1, "class", "svelte-1tar3ok");
    			add_location(svg1, file$3, 73, 8, 2356);
    			attr_dev(div2, "class", "chart-two svelte-1tar3ok");
    			add_location(div2, file$3, 72, 6, 2323);
    			attr_dev(div3, "class", "charts-container svelte-1tar3ok");
    			add_location(div3, file$3, 68, 4, 2211);
    			attr_dev(div4, "class", "section-container svelte-1tar3ok");
    			add_location(div4, file$3, 57, 2, 1865);
    			add_location(br0, file$3, 78, 2, 2438);
    			add_location(br1, file$3, 78, 8, 2444);
    			attr_dev(p1, "class", "body-text");
    			add_location(p1, file$3, 79, 2, 2454);
    			add_location(section, file$3, 55, 0, 1823);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$1, 1, 2, 28);
    			add_location(br0, file$1, 4, 4, 171);
    			add_location(br1, file$1, 4, 10, 177);
    			attr_dev(p0, "class", "body-text");
    			add_location(p0, file$1, 2, 2, 85);
    			attr_dev(a0, "class", "on-end svelte-1jnlkqb");
    			attr_dev(a0, "href", "https://d3js.org/");
    			add_location(a0, file$1, 8, 6, 261);
    			add_location(span0, file$1, 9, 6, 321);
    			attr_dev(p1, "class", "resource-item svelte-1jnlkqb");
    			add_location(p1, file$1, 7, 4, 228);
    			attr_dev(a1, "class", "on-end svelte-1jnlkqb");
    			attr_dev(a1, "href", "https://layercake.graphics/");
    			add_location(a1, file$1, 12, 6, 416);
    			add_location(span1, file$1, 13, 6, 490);
    			attr_dev(p2, "class", "resource-item svelte-1jnlkqb");
    			add_location(p2, file$1, 11, 4, 383);
    			attr_dev(a2, "class", "on-end svelte-1jnlkqb");
    			attr_dev(a2, "href", "https://katex.org/");
    			add_location(a2, file$1, 16, 6, 568);
    			add_location(span2, file$1, 17, 6, 629);
    			attr_dev(p3, "class", "resource-item svelte-1jnlkqb");
    			add_location(p3, file$1, 15, 4, 535);
    			attr_dev(a3, "class", "on-end svelte-1jnlkqb");
    			attr_dev(a3, "href", "https://svelte.dev/");
    			add_location(a3, file$1, 20, 6, 724);
    			add_location(span3, file$1, 21, 6, 787);
    			attr_dev(p4, "class", "resource-item svelte-1jnlkqb");
    			add_location(p4, file$1, 19, 4, 691);
    			attr_dev(div, "class", "resource-list svelte-1jnlkqb");
    			add_location(div, file$1, 6, 2, 195);
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 57, 8, 2305);
    		},
    		m: function mount(target, anchor) {
    			for (let i = 0; i < each_blocks.length; i += 1) {
    				if (each_blocks[i]) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p1.textContent = "And that's the end of our scrolly.";
    			attr_dev(h2, "class", "body-header");
    			add_location(h2, file, 42, 0, 1758);
    			attr_dev(p0, "class", "body-text");
    			add_location(p0, file, 43, 0, 1809);
    			attr_dev(div0, "class", "steps-container svelte-xapixo");
    			add_location(div0, file, 50, 4, 2054);
    			attr_dev(svg0, "id", "chart1");
    			attr_dev(svg0, "class", "svelte-xapixo");
    			add_location(svg0, file, 62, 8, 2434);
    			attr_dev(div1, "class", "chart-one svelte-xapixo");
    			add_location(div1, file, 61, 6, 2401);
    			attr_dev(svg1, "id", "chart2");
    			attr_dev(svg1, "class", "svelte-xapixo");
    			add_location(svg1, file, 65, 8, 2508);
    			attr_dev(div2, "class", "chart-two svelte-xapixo");
    			add_location(div2, file, 64, 6, 2475);
    			attr_dev(div3, "class", "charts-container svelte-xapixo");
    			add_location(div3, file, 60, 4, 2363);
    			attr_dev(div4, "class", "section-container svelte-xapixo");
    			add_location(div4, file, 49, 2, 2017);
    			add_location(br0, file, 69, 2, 2567);
    			add_location(br1, file, 69, 8, 2573);
    			attr_dev(p1, "class", "body-text");
    			add_location(p1, file, 70, 2, 2583);
    			add_location(section, file, 47, 0, 1975);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
